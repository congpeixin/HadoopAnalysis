...
tblproperties('hbase.table.name'='event_log');
...
-- 5. 上传transformer-0.0.1.jar到hdfs的/laoxiao/transformer文件夹中
-- 6. 创建hive的function
#create function platform_convert as 'com.laoxiao.transformer.hive.PlatformDimensionUDF' using jar 'hdfs://laoxiao/laoxiao/transformer/transformer-0.0.1.jar';  
create function date_convert as 'com.laoxiao.transformer.hive.DateDimensionUDF' using jar 'hdfs://laoxiao/laoxiao/transformer/transformer-0.0.1.jar';  
...
from event_logs 
where en='e_pv' and p_url is not null and pl is not null and s_time >= unix_timestamp('2016-04-26','yyyy-MM-dd')*1000 and s_time < unix_timestamp('2016-04-27','yyyy-MM-dd')*1000
